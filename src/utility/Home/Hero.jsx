...
const Hero = () => {
  ...
  return (
    <div
      className="relative flex flex-col justify-center items-center overflow-hidden px-4 
    ...
    >
      ...
      <div className="z-10 text-center max-w-3xl text-white">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link
            to="/flights"
            className="flex items-center gap-2 px-6 py-3 rounded-full bg-[#ff8a00] text-[#0b1d3a] font-semibold hover:shadow-xl hover:-translate-y-1 transition-transform duration-200"
          >
          ...
          <Link
            to="/assistant"
            className="flex items-center gap-2 px-6 py-3 rounded-full bg-[#10294f] text-[#ff8a00] font-semibold hover:shadow-lg hover:-translate-y-1 transition-transform duration-200"
          >
      ...
      {planes.map((plane) => (
        <FaPlane
          ...
          className={`absolute text-[7rem] text-white/30 opacity-80 transform will-change-transform
                      ${
                        plane.side === "left"
                          ? "bottom-[-10%] left-[-10%] animate-diagonalFly-left"
